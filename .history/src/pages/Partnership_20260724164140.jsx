        ...
        <section className="partner-request-card">
          <form onSubmit={handleSubmitRequestInstitution}>
                  ...
                  {isSearchInstitution &&
                    (!isSearchingInstitution ? (
                      getUniversitiesResults.length > 0 ? (
                        ...
                        <ul className="drop-search">
                          <li>
                            <i className="fa-brands fa-sistrix"></i> No results
                            found
                          </li>
                        </ul>
                      )
                    ...
                    {isOtherCampus && (
                      <div className="other-campus-form">
                        <p className="other-campus-note">
                          Your institution information above refers to the main
                          campus. If you belong to another campus, provide its
                          details below.
                        </p>
            ...
            <label className="partner-request-check">
              ...
              />
              <span>
                I confirm that I am authorized to submit this request on behalf
                of my institution.
              </span>
            </label>
