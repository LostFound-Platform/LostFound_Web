        ...
        <div className="faq-container">
          ...
          <details className="faq-item">
            ...
            <div className="faq-content">
              <p>
                Please check your email/username and password. If you forgot
          ...
          <details className="faq-item">
            ...
            <div className="faq-content">
              <p>
                Please contact the website administrator. After verification,
                the Admin will create and assign the account for you.
              </p>
            </div>
          </details>
          ...
          <details className="faq-item">
            ...
            <div className="faq-content">
              <p>
                Yes. We take data security seriously and protect your
