      ...
      <main>
        <div className="big-block-about">
          ...
          <div className="content">
            <p>
              Back2Me is a community-driven platform dedicated to helping people
            ...
            <p>
              Through the support of our growing community, Back2Me creates a
              safe and reliable space where users can share information,
              communicate easily, and support one another. Every post, share,
              and connection brings us one step closer to reuniting lost items
              with their owners and strengthening community bonds.
            </p>
          </div>
        ...
        <div className="offer-block">
          <div className="offer">
            ...
            <div className="offer-content">
              <p>
                This section allows users to easily post and browse lost or
                found items. By providing clear descriptions, locations, and
                images, our platform helps connect people quickly and
                accurately. Each listing brings us closer to reuniting lost
          ...
          <div className="offer-middle">
            ...
            <div className="offer-content">
              <p>
                This feature helps users quickly find relevant lost or found
                items by narrowing results based on category, location, date,
                and keywords. Smart Filters save time and improve accuracy,
                making it easier to match items and reconnect them with their
                owners.
              </p>
            </div>
          </div>
          <div className="offer">
            ...
            <div className="offer-content">
              <p>
                This map allows users to view lost and found items based on
                location. By displaying listings on a real-time map, users can
                easily see where items were lost or found and connect with
